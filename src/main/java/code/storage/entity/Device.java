...
public class Device implements RegisterEntity {
  ...
  @NotBlank
  @Size(max = 255)
  @Column(name = "fd_name", nullable = false, length = 255)
  ...
  @Column(name = "fd_price", nullable = false, precision = 12, scale = 2)
  private BigDecimal fdPrice;

  @NotNull
  @PositiveOrZero
  @Column(name = "fd_stock", nullable = false)
  private Integer fdStock;

  @NotNull
  @Column(name = "fd_release", nullable = false)
  private LocalDate fdRelease;

  @NotNull
  @PositiveOrZero
  @Column(name = "fd_ram", nullable = false)
  private Integer fdRam;

  @NotNull
  @PositiveOrZero
  @Column(name = "fd_storage", nullable = false)
  private Integer fdStorage;

  @NotNull
  @DecimalMin(value = "0.0")
  @Digits(integer = 3, fraction = 1)
  @Column(name = "fd_screen_size", nullable = false, precision = 4, scale = 1)
